...
class LegendrePolynomial3(torch.autograd.Function):
    ...
    def forward(ctx, input):
        ...
        # ctx.input_ref = weakref.ref(input)
...
def bar():
    ...
    for i in range(n_iter):
        indices_b = torch.randint(low=0, high=n, size=(batch,))
        taken_b = source_n[indices_b]
    ...
    print("per second", n_iter / (time_end - time_start))
