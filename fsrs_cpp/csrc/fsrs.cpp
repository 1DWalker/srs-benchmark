...
namespace fsrs {
    TORCH_LIBRARY(fsrs, m) {
        ...
        m.def("fsrs_batch_forward(Tensor parameters, Tensor review_ths, Tensor packed_review_th_T, Tensor packed_rating_T, Tensor packed_elapsed_days_real_T, Tensor packed_elapsed_days_int_T, Tensor packed_label_elapsed_days_real_T, Tensor packed_label_elapsed_days_int_T, Tensor perm_T_tensor, Tensor perm_inv_T_tensor, Tensor card_locs_T) -> (Tensor, Tensor)");
    }
}